...
- Recompiled plugin with Go version `1.24`. ([#662](https://github.com/turbot/steampipe-plugin-oci/pull/662))
- Recompiled plugin with [steampipe-plugin-sdk v5.13.1](https://github.com/turbot/steampipe-plugin-sdk/blob/develop/CHANGELOG.md#v5131-2025-09-25) that addresses critical and high vulnerabilities in dependent packages. ([#672](https://github.com/turbot/steampipe-plugin-oci/pull/672))

## v1.1.0 [2025-04-17]

_Dependencies_

- Recompiled plugin with Go version `1.23.1`. ([#641](https://github.com/turbot/steampipe-plugin-oci/pull/641))
- Recompiled plugin with [steampipe-plugin-sdk v5.11.5](https://github.com/turbot/steampipe-plugin-sdk/blob/v5.11.5/CHANGELOG.md#v5115-2025-03-31) that addresses critical and high vulnerabilities in dependent packages. ([#641](https://github.com/turbot/steampipe-plugin-oci/pull/641))
...
- Recompiled plugin with Go version `1.22`. ([#622](https://github.com/turbot/steampipe-plugin-oci/pull/622))
- Recompiled plugin with [steampipe-plugin-sdk v5.10.4](https://github.com/turbot/steampipe-plugin-sdk/blob/develop/CHANGELOG.md#v5104-2024-08-29) that fixes logging in the plugin export tool. ([#622](https://github.com/turbot/steampipe-plugin-oci/pull/622))
