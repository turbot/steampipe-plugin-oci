...
- The following tables have been renamed owing to the maximum character limit(63 bytes) set by PostgreSQL for identifiers. We recommend updating any scripts or workflows that use these tables to use the renamed equivalent tables instead ([#364](https://github.com/turbot/steampipe-plugin-oci/pull/364))
  - `oci_database_autonomous_database_metric_cpu_utilization` (replaced by `oci_database_autonomous_db_metric_cpu_utilization`)
  - `oci_database_autonomous_database_metric_cpu_utilization_daily` (replaced by `oci_database_autonomous_db_metric_cpu_utilization_daily`)
  - `oci_database_autonomous_database_metric_cpu_utilization_hourly` (replaced by `oci_database_autonomous_db_metric_cpu_utilization_hourly`)
  - `oci_database_autonomous_database_metric_storage_utilization` (replaced by `oci_database_autonomous_db_metric_storage_utilization`)
  - `oci_database_autonomous_database_metric_storage_utilization_daily` (replaced by `oci_database_autonomous_db_metric_storage_utilization_daily`)
  - `oci_database_autonomous_database_metric_storage_utilization_hourly` (replaced by `oci_database_autonomous_db_metric_storage_utilization_hourly`)
