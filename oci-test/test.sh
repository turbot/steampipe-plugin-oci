...
run_test oci_containerengine_cluster
...
run_test oci_core_instance_configuration
...
run_test oci_core_volume_group
run_test oci_database_autonomous_database
run_test oci_database_software_image
run_test oci_devops_project
run_test oci_devops_repository
...
run_test oci_identity_db_credential
run_test oci_identity_domain
...
run_test oci_mysql_heat_wave_cluster
...
run_test oci_queue_queue
run_test oci_resource_search
run_test oci_resourcemanager_stack
run_test oci_streaming_stream
