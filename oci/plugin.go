...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"oci_artifact_container_image":                                tableArtifactContainerImage(ctx),
			"oci_artifact_container_image_signature":                      tableArtifactContainerImageSignature(ctx),
			"oci_artifact_container_repository":                           tableArtifactContainerRepository(ctx),
			"oci_artifact_generic_artifact":                               tableArtifactGenericArtifact(ctx),
			"oci_artifact_repository":                                     tableArtifactRepository(ctx),
