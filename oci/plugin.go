...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"oci_certificate_certificate_authority_bundle":                 tableCertificatesCertificateAuthorityBundle(ctx),
			"oci_certificate_certificate_bundle":                           tableCertificatesCertificateBundle(ctx),
