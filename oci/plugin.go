...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"oci_artifacts_container_image":                                tableArtifactsContainerImage(ctx),
			...
			"oci_autoscaling_auto_scaling_configuration":                   tableAutoscalingAutoScalingConfiguration(ctx),
			...
			"oci_certificates_ca_bundle":                                   tableCertificatesCaBundle(ctx),
			"oci_certificates_certificate_authority_bundle":                tableCertificatesCertificateAuthorityBundle(ctx),
			"oci_certificates_certificate_bundle":                          tableCertificatesCertificateBundle(ctx),
