...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"oci_database_autonomous_database_metric_cpu_utilization":           tableDatabaseAutonomousDatabaseMetricCpuUtilization(ctx),
			"oci_database_autonomous_database_metric_cpu_utilization_daily":     tableDatabaseAutonomousDatabaseMetricCpuUtilizationDaily(ctx),
			"oci_database_autonomous_database_metric_storage_utilization":       tableDatabaseAutonomousDatabaseMetricStorageUtilization(ctx),
			"oci_database_autonomous_database_metric_storage_utilization_daily": tableDatabaseAutonomousDatabaseMetricStorageUtilizationDaily(ctx),
