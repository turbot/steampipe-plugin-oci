...
func Plugin(ctx context.Context) *plugin.Plugin {
	p := &plugin.Plugin{
		...
		TableMap: map[string]*plugin.Table{
			...
			"oci_certificate_certificate_bundle_version":                   tableCertificatesCertificateBundleVersion(ctx),
			...
			"oci_certificate_management_certificate_authority_version":     tableCertificatesManagementCertificateAuthorityVersion(ctx),
			"oci_certificate_management_certificate_version":               tableCertificatesManagementCertificateVersion(ctx),
