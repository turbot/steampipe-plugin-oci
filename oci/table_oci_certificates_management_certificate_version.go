...
func listCertificatesManagementCertificateVersions(ctx context.Context, d *plugin.QueryData, h *plugin.HydrateData) (interface{}, error) {
	...
	logger.Debug("oci_certificates_management_certificate_version.listCertificatesManagementCertificateVersions", "OCI_REGION", region)

	equalQuals := d.EqualsQuals
	// Create Session
	session, err := certificatesManagementService(ctx, d, region)
	if err != nil {
		logger.Error("oci_certificates_management_certificate_version.listCertificatesManagementCertificateVersions", "connection_error", err)
		return nil, err
	}
	...
	for pagesLeft {
		...
		if err != nil {
			logger.Error("oci_certificates_management_certificate_version.listCertificatesManagementCertificateVersions", "api_error", err)
			return nil, err
		}
...
func getCertificatesManagementCertificateVersion(ctx context.Context, d *plugin.QueryData, h *plugin.HydrateData) (interface{}, error) {
	...
	logger.Debug("oci_certificates_management_certificate_version.getCertificatesManagementCertificateVersion", "OCI_REGION", region)
	...
	session, err := certificatesManagementService(ctx, d, region)
	if err != nil {
		logger.Error("oci_certificates_management_certificate_version.getCertificatesManagementCertificateVersion", "connection_error", err)
		return nil, err
	}
	request.RequestMetadata = common.RequestMetadata{
		RetryPolicy: getDefaultRetryPolicy(d.Connection),
	...
	if err != nil {
		logger.Error("oci_certificates_management_certificate_version.getCertificatesManagementCertificateVersion", "api_error", err)
		return nil, err
	}
